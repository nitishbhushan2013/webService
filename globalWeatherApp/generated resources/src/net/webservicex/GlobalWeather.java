    ...
    extends Service
{
    ...
    static {
        GLOBALWEATHER_WSDL_LOCATION = net.webservicex.GlobalWeather.class.getClassLoader().getResource("META-INF/wsdl/GlobalWeather.wsdl");
        WebServiceException e = null;
        if (GLOBALWEATHER_WSDL_LOCATION == null) {
            e = new WebServiceException("Cannot find 'META-INF/wsdl/GlobalWeather.wsdl' wsdl. Place the resource correctly in the classpath.");
        }
